...
export class FizzModule {
  ...
  async listenToFizzCreated(
    ...
    try {
      ...
      console.error('Error in listenToFizzCreated -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async updateFizzSpecs(specs: string) {
    try {
      ...
      console.error('Error in updateFizzSpecs -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async listenSpecUpdated(
    ...
    try {
      ...
      console.error('Error in listenToFizzNodeUpdated -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async updateFizzRegion(region: string) {
    try {
      ...
      console.error('Error in updateFizzRegion -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async updateFizzProvider(providerId: bigint) {
    try {
      ...
      console.error('Error in updateFizzProvider -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async addAcceptedPayment(tokenAddress: string) {
    try {
      ...
      console.error('Error in addAcceptedPayment -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async listenToAddAcceptedPayment(
    ...
    try {
      ...
      console.error('Error in listenToAddAcceptedPayment -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async removeAcceptedPayment(tokenAddress: string) {
    try {
      ...
      console.error('Error in removeAcceptedPayment -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
  ...
  async listenToRemoveAcceptedPayment(
    ...
    try {
      ...
      console.error('Error in listenToRemoveAcceptedPayment -> ', error);
      const errorMessage = handleContractError(error, FizzRegistryAbi);
      throw errorMessage;
    }
  }
